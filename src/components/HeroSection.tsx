...
const HeroSection = () => {
  ...
  return <section className="relative pt-32 pb-20 overflow-hidden" id="hero">
      {/* Background gradient */}
          ...
          <div className="relative animate-scale-in flex justify-center">
            <div className="relative w-full max-w-md aspect-square">
              <svg viewBox="0 0 400 400" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                ...
                <polyline points="75,140 85,130 95,135 105,125 115,120 125,115 135,110 145,105" fill="none" stroke="#6366f1" strokeWidth="2" />
                ...
                {/* Growth Arrow */}
                <path d="M 250 180 L 320 180 L 315 175 M 320 180 L 315 185" stroke="#10b981" strokeWidth="3" fill="none" />
